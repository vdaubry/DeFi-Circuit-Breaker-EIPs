...
import {IERC173, IERC7265CircuitBreaker} from "../interfaces/INewCircuitBreaker.sol";
import {Limiter, LiqChangeNode} from "../static/Structs.sol";
import {LimiterLib, LimitStatus} from "../utils/LimiterLib.sol";

contract NewCircuitBreaker is IERC7265CircuitBreaker, Ownable {
    ...
    function _onTokenOutflow(
        ...
        if (limiter.status() == LimitStatus.Triggered) {
            ...
            // lock funds here
            _safeTransferIncludingNative(_token, timelock, _amount);
