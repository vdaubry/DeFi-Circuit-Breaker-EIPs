 ...
 */
contract DelayedSettlementModule is IDelayedSettlementModule, TimelockController {
        ...
        returns (bytes32 newEffectID)
    {
        ...
        super.schedule(target, value, innerPayload, bytes32(0), bytes32(0), getMinDelay());
        return newEffectID;
    }
    ...
    function pausedTill() external view override returns (uint256 pauseTimestamp) {
